...
_io = [
    ...
    ("qsfp", 0,
        Subsignal("rx_n", Pins("F1 G3 H1 J3")),
        Subsignal("rx_p", Pins("F2 G4 H2 J4")),
        Subsignal("tx_n", Pins("F6 G8 H6 J8")),
        Subsignal("tx_p", Pins("F7 G9 H7 J9")),
    ),
    ("qsfp", 1,
        Subsignal("rx_p", Pins("K1  L3  M1  N3 ")), 
        Subsignal("rx_n", Pins("K2  L4  M2  N4 ")),
        Subsignal("tx_p", Pins("K6  L8  M6  N8 ")), 
        Subsignal("tx_n", Pins("K7  L9  M7  N9 ")),
    )
    ("qsfp", 2,
        Subsignal("rx_p", Pins("P1  R3  T1  U3 ")), 
        Subsignal("rx_n", Pins("P2  R4  T2  U4 ")), 
        Subsignal("tx_p", Pins("P6  R8  T6  U8 ")), 
        Subsignal("tx_n", Pins("P7  R9  T7  U9 ")),
    )
    ("qsfp", 3,
        Subsignal("rx_p", Pins("AB1 AC3 AD1 AE3")), 
        Subsignal("rx_n", Pins("AB2 AC4 AD2 AE4")), 
        Subsignal("tx_p", Pins("AB6 AC8 AD6 AE8")), 
        Subsignal("tx_n", Pins("AB7 AC9 AD7 AE9")),
    ),
    # PCIe
    ("pcie_x2", 0,
